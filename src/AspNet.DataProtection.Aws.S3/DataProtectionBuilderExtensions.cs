...
namespace AspNetCore.DataProtection.Aws.S3
{
    ...
    public static class DataProtectionBuilderExtensions
    {
        ...
        private static IDataProtectionBuilder PersistKeysToAwsS3Impl(this IDataProtectionBuilder builder,
                                                                     IAmazonS3 s3Client,
                                                                     Func<IServiceProvider, IOptions<S3XmlRepositoryConfig>> getOptions)
        {
            ...
            builder.Services.AddSingleton<IConfigureOptions<KeyManagementOptions>>(serviceProvider =>
                                                                                   {
                                                                                       ...
                                                                                       TypeDescriptor.AddAttributes(typeof(S3StorageClass),
                                                                                                                    new TypeConverterAttribute(typeof(AmazonConstantClassConverter<
                                                                                                                        S3StorageClass>)));
                                                                                       TypeDescriptor.AddAttributes(typeof(ServerSideEncryptionCustomerMethod),
                                                                                                                    new TypeConverterAttribute(typeof(AmazonConstantClassConverter<
                                                                                                                        ServerSideEncryptionCustomerMethod>)));
                                                                                       TypeDescriptor.AddAttributes(typeof(ServerSideEncryptionMethod),
                                                                                                                    new TypeConverterAttribute(typeof(AmazonConstantClassConverter<
                                                                                       ...
                                                                                       return new ConfigureOptions<KeyManagementOptions>(options =>
                                                                                       {
                                                                                           options.XmlRepository =
                                                                                               loggerFactory != null
                                                                                                   ? new S3XmlRepository(s3Client,
                                                                                                       boundOptions,
                                                                                                       loggerFactory.CreateLogger<S3XmlRepository>())
                                                                                                   : new S3XmlRepository(s3Client, boundOptions);
                                                                                       });
                                                                                   });
            return builder;
        }
